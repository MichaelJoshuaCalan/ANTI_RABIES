...
include"db_conn.php";
  ...
  for($i=1; $i<=12; $i++){
    $query = "SELECT COUNT(*) as count FROM record_s WHERE MONTH(Date)=$i AND YEAR(Date)=2023 ";
            ...
            <div class="card-body">
              <h5 class="card-title" style="display: flex;justify-content:space-between">Monthy Report (2023) <a class="back" href="table.php" style="font-size:30px;"><i class="bi bi-arrow-bar-left"></i>&nbsp;Back</a></h5>
                <div class="total">
                  <?php 
                    include "db_conn.php";
                    $query="SELECT COUNT(*) as count FROM record_s WHERE YEAR(Date)=2023";
                    $result = mysqli_query($conn,$query);
                  ...
                  <?php 
                    include "db_conn.php";
                    $query="SELECT COUNT(*) as count FROM record_s WHERE YEAR(Date)=2023 AND sex='m'";
                    $result = mysqli_query($conn,$query);
                  ...
                  <?php 
                    include "db_conn.php";
                    $query="SELECT COUNT(*) as count FROM record_s WHERE YEAR(Date)=2023 AND sex='f'";
                    $result = mysqli_query($conn,$query);
                  ...
                  <h5 style="margin-left:-1px"><i style="color:#023020;" class="bi bi-person-arms-up"></i><?php echo " <strong>". $total_patient['count']."</strong>"?></h5>
                  <h5><i style="color:#0096FF;" class="bi bi-person-standing"></i> <?php echo " <strong>". $total_male['count']."</strong>";?></h5>
                  <h5><i style="color:#FF69B4;" class="bi bi-person-standing-dress"></i><?php echo " <strong>". $total_female['count']."</strong>"?></h5>
                  </div>
                </div>
              <!-- Bar Chart -->
