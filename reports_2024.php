...
include"db_conn.php";
  ...
  for($i=1; $i<=12; $i++){
    $query = "SELECT COUNT(*) as count FROM record_s WHERE MONTH(Date)=$i AND YEAR(Date)=2024 ";
    ...
    <section class="section">
      <div class="row" style="display:flex;align-items:center;justify-content: center;margin-top:-5%;">
        <div class="col-lg-6" style="width:90%;">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title" style="display: flex;justify-content:space-between">Monthy Report (2024) <a class="back" href="table.php" style="font-size:30px;"><i class="bi bi-arrow-bar-left"></i>&nbsp;Back</a></h5>
                <div class="total">
                  <?php 
                    include "db_conn.php";
                    $query="SELECT COUNT(*) as count FROM record_s WHERE YEAR(Date)=2024";
                    $result = mysqli_query($conn,$query);
                  ...
                  <?php 
                    include "db_conn.php";
                    $query="SELECT COUNT(*) as count FROM record_s WHERE YEAR(Date)=2024 AND sex='m'";
                    $result = mysqli_query($conn,$query);
                  ...
                  <?php 
                    include "db_conn.php";
                    $query="SELECT COUNT(*) as count FROM record_s WHERE YEAR(Date)=2024 AND sex='f'";
                    $result = mysqli_query($conn,$query);
